...
Note: The default server returns the Not Found page with the 404 status code for all requests for domains for which there are no Ingress rules defined. For testing purposes, I include a self-signed certificate and key that I generated. However, I recommend that you use your own certificate and key.
At first you have to create cert and key for kubernetes secret file.
...
3. Create a config map for customizing NGINX configuration (read more about customization here):
